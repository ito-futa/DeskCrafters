    ...
    <>
      ...
      <section className='tools' id="tools">
        ...
        <div className='flex'>
          ...
          <ul>
            <li><b>電動ドライバー</b>安価だけどめちゃくちゃ使う。超便利。</li>
            <li><b>L字ステー</b>木と木をつなぐ道具。ダボ穴より目立つが手軽。</li>
            <li><b>ワッシャー</b>L字ステーで木を接合する時に利用。</li>
            <li><b>RYOBIサンダ</b>木の表面を滑らかにするためのヤスリがけに利用。</li>
            <li><b>みつろうクリーム</b>塗装後のツヤ消し・ツヤ出しに</li>
          </ul>
        </div>
      </section>
      ...
      <section className='items' id="items">
        ...
        <div className='flex'>
          ...
          <ul>
            ...
            <li><b>3COINS ストーンディフューザー</b><p>3COINSのコスパぶっ壊れ製品。<br />たしか500円の商品だが、他の店の製品でここまで質感の良いものは倍の金額を出してもまずない。</p></li>
          </ul>
        </div >
